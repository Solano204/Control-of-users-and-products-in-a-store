...
public class ExitsProvider extends Controller.Conexion { // THIS CLAS SERVES TO SEARCH A CLIENT BY DNI CUSTOMER

    private final Connection con;
    private ResultSet res;
    private CallableStatement ps;

    public ExitsProvider() {
        this.con = establihsConnection();
    }

    public boolean searchUser(String DniCustomer) {
        try {
            String searchQuery = "{CALL Search_Provider (?)}";
